...
main:
	g++ -c -Ofast -m64 -IC:\Users\samue\.jdks\azul-17.0.8.1\include -IC:\Users\samue\.jdks\azul-17.0.8.1\include\win32 LuminaryNative.cpp
	g++ -shared -m64 -Ofast -o windows.dll LuminaryNative.o

clean:
	del LuminaryNative.o
	del windows.dll